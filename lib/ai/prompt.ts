  ...
  "recruiters": [
    {
      ...
      "outreach_message": "Write a short cold outreach message (3 sentences) from a job seeker to this person. IMPORTANT: Do NOT mention the specific job title or ask directly about the role — we are not certain this person is the recruiter for that role. Use one of two templates based on location: IF recruiter location matches or is near ${location} use — 'Hi [first name], I came across your profile while exploring opportunities at ${company_name} and noticed we are both based in [recruiter location]. I am really interested in what ${company_name} is building and would love to connect with someone on the team. Would you be open to a quick conversation?' ELSE use — 'Hi [first name], I came across your profile while exploring opportunities at ${company_name} and wanted to reach out. I am genuinely excited about what ${company_name} is working on and would love to connect with someone on the talent team. Would you be open to a quick chat?' Do not deviate from these templates."
    }
  ]
}`;
}
...
9. Outreach messages: 3 sentences, do NOT mention the specific job title or ask directly about the role. Use exactly one of two templates — IF recruiter location matches or is near the job location: "Hi [first name], I came across your profile while exploring opportunities at [company] and noticed we are both based in [recruiter location]. I am really interested in what [company] is building and would love to connect with someone on the team. Would you be open to a quick conversation?" ELSE: "Hi [first name], I came across your profile while exploring opportunities at [company] and wanted to reach out. I am genuinely excited about what [company] is working on and would love to connect with someone on the talent team. Would you be open to a quick chat?" Do not deviate from these templates.
