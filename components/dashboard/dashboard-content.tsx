  ...
  return (
    <div className="min-h-screen mesh-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <button
          onClick={() => setModalOpen(true)}
          className="fixed bottom-6 right-6 sm:hidden w-14 h-14 rounded-full bg-brand-400 flex items-center justify-center shadow-glow-lg text-white z-30 hover:scale-110 active:scale-95 transition-transform"
